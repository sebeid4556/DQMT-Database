...
{    
    ...
    TestButton2 *button = new TestButton2("../resource/test_button1.png", "../resource/test_button2.png", this);
    ...
    filter_screen->addImage("../resource/filter1.png", {0, 0, UIManager::DEFAULT_WINDOW_WIDTH, 100});
    filter_screen->addImage("../resource/filter1.png", {0, 100, UIManager::DEFAULT_WINDOW_WIDTH, 100});
    filter_screen->addImage("../resource/filter1.png", {0, 200, UIManager::DEFAULT_WINDOW_WIDTH, 100});
    filter_screen->addImage("../resource/filter1.png", {0, 300, UIManager::DEFAULT_WINDOW_WIDTH, 100});
    filter_screen->addImage("../resource/filter1.png", {0, 400, UIManager::DEFAULT_WINDOW_WIDTH, 100});
    filter_screen->addImage("../resource/filter1.png", {0, 500, UIManager::DEFAULT_WINDOW_WIDTH, 100});
    filter_screen->addImage("../resource/filter1.png", {0, 600, UIManager::DEFAULT_WINDOW_WIDTH, 100});    
    ...
    filter_blur->addImage("../resource/filter2.png", {0, 600, UIManager::DEFAULT_WINDOW_WIDTH, 100}, FLIP_VERTICAL);
